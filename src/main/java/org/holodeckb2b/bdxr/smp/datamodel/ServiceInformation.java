...
public class ServiceInformation extends ServiceMetadataResult {
    ...
    private List<ProcessList>   	processInformation;
     ...
     */
    public ServiceInformation(final Identifier participant, final Identifier service, List<ProcessList> processes,
    ...
    /**
     * Adds the meta-data of one process list in which this service if offered to the list of process meta-data
     *
